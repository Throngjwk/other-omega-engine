...
<div class="resource">
    <p>You have {{formatNumber(mod.points, 2, 2, 1e9)}} <span class="omega">P</span></p>
    <p>You get {{formatNumber(mod.getModGain(), 2, 2, 1e9)}} <span class="omega">P</span> every second</p>
