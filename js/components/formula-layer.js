...
<div class="tabs">
    ...
    <button @click="formula.FixBGain()">Change a B</button>
</div>
...
<div class="upgrades">
    ...
    <formula-upgrade2 :upgrade="formula.upgrades.divRP"></formula-upgrade2>
    <formula-upgrade2 :upgrade="formula.upgrades.mulitB2"></formula-upgrade2>
</div>
</div>`
});