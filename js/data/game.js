const game = {
    ...
    achievements: [
        ...
        new Achievement("Wrong Generator Layer 3", "Buy 1 <span>L3<sub>1</sub></span> Generator", "<span>L2<sub>6</sub></span>", () => game.layers[2] && game.layers[2].generators[5].bought.gt(0)),
