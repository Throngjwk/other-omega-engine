const game = {
    ...
    achievements: [
        ...
        new Achievement("Pα", "Reach 20 a", "<span>a<sub>1</sub></span>", () => game.formulaLayer.a.gte(20)),
        new Achievement("QoL-α", "Reach 75 a", "<span>a<sub>2</sub></span>", () => game.formulaLayer.a.gte(75)),
