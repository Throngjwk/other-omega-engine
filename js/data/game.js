const game = {
    ...
    achievements: [
        ...
        new Achievement("To a Infinity!", "Reach 1.8e308 alpha.", "&alpha;", () => game.layers[0] && game.layers[0].resource.gte("1.8e308")),
        new Achievement("I dont!", "Reach 1.8e708 alpha.", "&alpha;", () => game.layers[0] && game.layers[0].resource.gte("1.8e708")),
