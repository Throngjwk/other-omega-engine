    ...
    constructor()
    {
        ...
        this.multiplierUpgrades = [
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().div(game.formulaLayer.upgrades.divRMRP.apply()),
                level => new Decimal(1),
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(3).mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().add(10).div(game.formulaLayer.upgrades.divRMRP.apply()),
                level => new Decimal(1),
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(12).mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().add(47).div(game.formulaLayer.upgrades.divRMRP.apply()),
                level => new Decimal(1),
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(48).mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().add(143).div(game.formulaLayer.upgrades.divRMRP.apply()),
                level => new Decimal(1),
